import { createPost, getPosts, getMyPosts, updatePost, deletePost } from "../controllers/postController.js";

export default function registerPostRoutes(app, authenticateToken, upload, io) {
  app.post("/api/posts", authenticateToken, upload.single("imagem"), createPost);
