...
export default function registerFriendRoutes(app, authenticateToken, io) {
  app.post("/api/friends/request", authenticateToken, requestFriend(io));
  ...
  app.post("/api/friends/reject", authenticateToken, rejectFriend(io));
  app.delete("/api/friends/:id", authenticateToken, removeFriend(io));
  app.delete("/api/friends/request/:id", authenticateToken, cancelRequest(io));
}
